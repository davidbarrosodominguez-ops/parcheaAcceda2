...
- **Coherencia Tarea-Plantilla:** Cuando se modifique la tarea de un fichero `.yml` que afecte a la información reportada, se debe verificar que la modificación no afecta a su representación gráfica en el `.j2` correspondiente. Si es necesario, la plantilla `.j2` también debe ser modificada 