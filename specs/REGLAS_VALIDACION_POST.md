...
| :--- | :--- | :--- | :--- |
| **Copia** | El informe final no se copió correctamente al almacén. | La tarea en `13_postchecks.yml` verifica si el fichero del informe existe en el directorio de destino después de la operación de copia. | `REVISAR_La copia del informe final al almacén ha fallado._REVISAR` |
| **Limpieza** | Los ficheros temporales no se eliminaron correctamente. | La tarea en `13_postchecks.yml` verifica que los ficheros temporales del informe ya no existen después de la operación de borrado. | `REVISAR_La limpieza de los ficheros temporales ha fallado._REVISAR` |
